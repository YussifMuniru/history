...
//     foreach ($draw_numbers as $draw_number) {
//         array_push($history_array, [ "sum" => array_sum($draw_number), "b_s" => array_sum($draw_number) >= 11 ? "B" : "S", "fish_prawn_crab" => $objects[intval($draw_number[0])] . " " .  $objects[intval($draw_number[1])] . " " . $objects[intval($draw_number[2])]]);
//     }
...
// function no_layout_stats_fast3(array $drawNumbers, $count): array
// {
...
// {
//     return [
//         'b_s_o_e_sum'   => streamline_segments_3d([
//             'draw_period' => ['winning_and_draw_periods', [$draw_numbers, 'd']], 'winning' => ['winning_and_draw_periods', [$draw_numbers, 'w']], 'b_s_o_e_sum'   => ['b_s_o_e_sum', [$draw_numbers]], "sum_span"   => ['_sum_span', [$draw_numbers, [0, 3]]],
//             "chart_1" => ['chart_no_3d', [$draw_numbers, 0]],
//             "chart_2" => ['chart_no_3d', [$draw_numbers, 1]],
//             "chart_3" => ['chart_no_3d', [$draw_numbers, 2]],
//             'no_layout' => ['no_layout_3d', [$draw_numbers, [0, 3]]],
//         ]),
