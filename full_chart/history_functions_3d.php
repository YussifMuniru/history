...
//         $startingIndex = 0;
//         $endIndex      = 3;
//         array_unshift($history_array['sum'],  sumPattern($draw_number, $startingIndex, $endIndex));
//         array_unshift($history_array['span'], spanPattern($draw_number, $startingIndex, $endIndex));
//     }
...
// function chart_no_stats_3d(array $drawNumbers, $index,$count): array
// {
//     $history_array  = [];
//     $nums_for_layout = [
//         0 => "zero", 1 => "one", 2 => "two", 3 => "three", 4 => "four", 5 => "five",
...
//             'draw_period' => ['winning_and_draw_periods', [$drawNumber, 'd']], 'winning'     => ['winning_and_draw_periods', [$drawNumber, 'w']], 'all3group'   => ['all3group', [$drawNumber]], "sum_span"   => ['_sum_span', [$drawNumber]], 
//             "chart_1" => ['chart_no_3d', [$drawNumber, 0]],
//             "chart_2" => ['chart_no_3d', [$drawNumber, 1]],
//             "chart_3" => ['chart_no_3d', [$drawNumber, 2]],
//             "chart_4" => ['chart_no_3d', [$drawNumber, 3]],
//             "chart_5" => ['chart_no_3d', [$drawNumber, 4]],
//             'no_layout' => ['no_layout_3d', [$drawNumber, [0, 5]]],
//         ]),
